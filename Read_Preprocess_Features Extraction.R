...
#load data
train=read.csv("/media/vidyashree/OS/Study Material/Data Analytics/DataSet/train.csv")
test=read.csv("/media/vidyashree/OS/Study Material/Data Analytics/DataSet/test.csv")
...
train_x=train_test[1:1460,-"Utilities"]
